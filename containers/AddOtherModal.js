...
class AddOtherModal extends Component {
    ...
    async addComputer(){
        await axios.put(route+"other/" + this.state.id,{
        ...
        return(
            <div className="edit-modal">
                ...
                <div className="edit-modal-row" style={{justifyContent: 'center'}}>
                    <button className="edit-modal-confirm" onClick={() => this.addComputer()}>Confirm</button>
                </div>
            </div>
        )
    }
